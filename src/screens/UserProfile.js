            ...
            <div style={{
                ...
                <div>
                    <img style={{ width: "120px", height: "120px", borderRadius: "50%" }}
                        src={userProfile.user.pic} alt="personimg" />
                ...
                <div>
                    ...
                    {
                        showFollow?  <button className="btn waves-effect waves-light #448aff blue accent-2" style={{margin:"10px"}}
                        onClick={()=>followUser()}>Follow</button>

                        : 

                        <button className="btn waves-effect waves-light #448aff blue accent-2" style={{margin:"10px"}}
